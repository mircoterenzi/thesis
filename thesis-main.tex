...
Allo stato attuale, il progetto mira a fornire una base solida che incapsula le caratteristiche principali di SQL. Partendo dal 
...
A conclusione di questa tesi, vorrei ringraziare il mio relatore, professor Mirko Viroli, e il mio correlatore, professor Gianluca Aguzzi, per il tempo che mi è stato dedicato durante la realizzazione del progetto e dell'elaborato.\\
Successivamente, vorrei ringraziare la mia famiglia per avermi supportato e per avermi reso la persona che sono oggi. In particolare, ringrazio Viola per essermi sempre stata vicina in questi anni, incoraggiandomi a dare il meglio e aiutandomi a superare i momenti più difficili.\\
Vorrei ringraziare anche tutti i miei amici, quelli di sempre e quelli che ho conosciuto durante questa avventura, per tutti i bei momenti trascorsi.\\
