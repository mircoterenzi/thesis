...
Neverlang è un framework che facilita la definizione di linguaggi di programmazione in modo incrementale ed agile, consentendo la 
...
componente del linguaggio, chiamato \textit{slice}, di essere sviluppato, testato e sostituito in maniera indipendente \cite{Cazzola2023}.
