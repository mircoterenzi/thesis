...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        tabella riguarda il tipo dei dati inseriti in ogni colonna, il quale dovrà corrispondere con il dato indicato durante l'operazione 
        di creazione. In aggiunta, è possibile indicare altre caratteristiche che il dato inserito dovrà rispettare, come l’unicità (ossia 
